...
public class ShopeeAuth {
    ...
    public static String generateAuthUrl(String redirectUrl) throws Exception {
        ...
        String authUrl = RuntimeConfig.getApiHost() + ShopeeConfig.AUTH_PARTNER_PATH +
                "?partner_id=" + RuntimeConfig.getPartnerId() +
                "&timestamp=" + timestamp +
                "&sign=" + sign +
                "&redirect=" + redirectUrl;

        System.out.println("=== Generated Auth URL ===");
        System.out.println("Partner ID: " + RuntimeConfig.getPartnerId());
        System.out.println("Partner Key: " + RuntimeConfig.getPartnerKey());
        System.out.println("API Host: " + RuntimeConfig.getApiHost());
    ...
    public static String getAccessToken(long shopId, String code) throws Exception {
        ...
        String urlString = RuntimeConfig.getApiHost() + ShopeeConfig.AUTH_TOKEN_PATH +
                "?partner_id=" + RuntimeConfig.getPartnerId() +
                "&timestamp=" + timestamp +
                "&sign=" + sign;
