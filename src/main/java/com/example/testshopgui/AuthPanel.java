...
public class AuthPanel {
    ...
    private void createPanel() {
        ...
        TextArea instructions = new TextArea(
            "Authorization Steps:\n\n" +
            "⚠️ IMPORTANT: If your backend callback URL is running, it will automatically\n" +
            "consume the authorization code. For manual testing, use a non-existent URL\n" +
            "in Settings (e.g., http://localhost:9999/callback) or stop your backend.\n\n" +
            "1. Go to Settings tab and check Backend Callback URL\n" +
            "2. For manual testing, change it to a test URL (e.g., http://localhost:9999/callback)\n" +
            "3. Click 'Generate Auth URL' to create authorization link\n" +
            "4. Copy the URL and open it in a browser\n" +
            "5. Login to Shopee and authorize your app\n" +
            "6. After redirect, copy the 'code' parameter from the URL\n" +
            "7. Paste the code and click 'Complete Authorization'\n" +
            "8. Tokens will be automatically saved"
        );
