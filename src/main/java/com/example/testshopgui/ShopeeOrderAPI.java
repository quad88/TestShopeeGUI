...
public class ShopeeOrderAPI {
    ...
    public static String getOrderList(long shopId, String accessToken) throws Exception {
        ...
        // Log request details
        System.out.println("=== ORDER API REQUEST ===");
        System.out.println("Partner ID (from RuntimeConfig): " + RuntimeConfig.getPartnerId());
        System.out.println("API Host (from RuntimeConfig): " + RuntimeConfig.getApiHost());
        ...
        // Display response
        System.out.println("Order List Response (took " + (endTime - startTime) + "ms):");
